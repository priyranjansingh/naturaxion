        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="<?php echo base_url() . '/admin'; ?>" class="logo">
                    ...
                    <span class="logo-mini"><b>NM</b></span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><b>Naturaxion</b></span>
                </a>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="<?php echo isMenuActive(array('adminusers'),Yii::app()->controller->id); ?>"><a href="<?php echo base_url() . "/admin/adminusers"; ?>"><i class="fa fa-users"></i> <span>Admin Users</span></a></li>
                        <li class="<?php echo isMenuActive(array('category'),Yii::app()->controller->id); ?>"><a href="<?php echo base_url() . "/admin/category"; ?>"><i class="fa fa-tasks"></i> <span>Category</span></a></li>
                    </ul>
                </section>
                <!-- /.sidebar -->
            </aside>
