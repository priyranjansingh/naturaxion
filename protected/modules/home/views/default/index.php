...
<div class="clearfix"></div>
            ...
            <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0; left: 0px; width: 960px; height: 300px; overflow: hidden; visibility: hidden;">
                ...
                <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 960px; height: 300px; overflow: hidden;">
                    <div> <img data-u="image" src="<?php echo $baseUrl; ?>/img/banner1.jpg" /> </div>
                    <div> <img data-u="image" src="<?php echo $baseUrl; ?>/img/banner2.jpg" /> </div>
                    <div> <img data-u="image" src="<?php echo $baseUrl; ?>/img/banner3.jpg" /> </div>
                    <div> <img data-u="image" src="<?php echo $baseUrl; ?>/img/banner4.jpg" /> </div>
                    <div> <img data-u="image" src="<?php echo $baseUrl; ?>/img/banner5.jpg" /> </div>
                    <div> <img data-u="image" src="<?php echo $baseUrl; ?>/img/banner1.jpg" /> </div>
                </div>
